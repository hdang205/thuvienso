...
**Version**: 1.0
**Status**: Draft
**Last updated by human**: 2026-04-11
**Product owner**: TBD
...
Dự án thư viện số FBU là hệ thống quản lý thư viện số hóa giúp sinh viên dễ dàng chọn lựa và mượn trả sách. Nó giải quyết vấn đề thủ thư tốn nhiều thời gian quản lý nhập kho sách thủ công, và sinh viên thường chọn sách không phù hợp với hướng học tập hoặc quên trả sách đúng hạn. Người dùng chính là thủ thư và sinh viên. Kết quả mong muốn là tối ưu hóa quy trình quản lý thư viện, giảm thời gian xử lý và cải thiện trải nghiệm người dùng.
