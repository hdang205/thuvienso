# thư viện số FBU — Claude Instructions

> Stack: HTML, CSS, JavaScript · JavaScript, MySQL, Django · MySQL · GitHub Pages
...
- **Unit tests**: Vitest — colocated as `*.test.js` next to source files
- **E2E tests**: Playwright — in `tests/e2e/*.spec.js`
- **Run unit**: `npm test`
